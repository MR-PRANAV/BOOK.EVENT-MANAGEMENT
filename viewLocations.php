                ...
                <table class ="table table-hover">
                    ...
                    <tbody>
                        ...
                        while ($row) {
                            ...
                            echo '<td>'
                            // . '<a href="viewLocation.php?id='.$row['LocationID'].'" class="btn btn-primary">View</a> '
                            . '<a href="editLocationForm.php?id='.$row['LocationID'].'" class="btn btn-success">Edit</a> '
                            . '<a class="delete" href="deleteLocation.php?id='.$row['LocationID'].'"class="btn btn-success">Delete</a> '
                            . '</td>';
                            echo '</tr>';  
