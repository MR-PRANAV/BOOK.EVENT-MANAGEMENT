        ...
        <div class = "content">
            <div class = "container">
                ...
                <form action="createEvent.php" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="Cost" class="col-md-2 control-label">Event Cost</label><!--cost-->
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label for="LocID" class="col-md-2 control-label">Event Location</label><!--location id-->
                        <div class="col-md-5">
                            <select name="LocID"
                                        id="LocID"
                                        class="form-control"
                                ...
                                <br>
                                <a class="btn btn-default" href = "createLocationForm.php">Add New Location</a>
                        </div>
                        <div class="col-md-4">
