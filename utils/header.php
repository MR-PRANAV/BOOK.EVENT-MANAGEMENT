    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron"><!--jumbotron-->
                <h3>⁜ We Create Your Celebration Greater Than Better ⁜</h3><!--jumbotron heading-->
                <p><!--jumbotron content-->
                _Sai_Events_&_Flames_ is your premier destination for all your event planning and design needs With a commitment to making your celebrations truly extraordinary, we offer a wide range of services to turn your special moments into unforgettable memories...
                </p>
                <p> ※Event Planning... <br>
                    ※Event Design... <br>
                    ※Event Decoration... <br>
                    ※Destination wedding Event management...</p>
                <p id="dateAndTime"></p>
            </div>
        </div>
    </div>
